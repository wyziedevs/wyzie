  ...
  <body class="bg-mono-background min-h-screen flex flex-col items-center justify-center p-4 cursor-default">
        ...
        <section>
          <div class="space-y-4 mb-5">
            <div class="bg-mono-accent shadow-xl p-4 rounded-md flex flex-col gap-1">
              ...
              <a href="https://github.com/wyziedevs/wyzie-lib" class="text-sm text-primary-500 hover:text-primary-600 transition duration-100 break-words" alt="Source code for Wyzie Subs" title="Source code for Wyzie Subs">
                Source Code
              </a>
            </div>
            ...
            <div class="bg-mono-accent shadow-xl p-4 rounded-md flex flex-col gap-1">
              ...
              <a href="https://github.com/wyziedevs/wyzie-lib" class="text-sm text-primary-500 hover:text-primary-600 transition duration-100 break-words" alt="Source code for Wyzie Lib" title="Source code for Wyzie Lib">
                Source Code
              </a>
            </div>
    ...
    <footer class="mt-8 text-center text-type-footer text-sm">
      <p class="flex justify-center items-center space-x-2">
        <a href="https://github.com/wyziedevs/wyzie" target="_blank" rel="noopener noreferrer" class="hover:text-primary-600 text-dark transition duration-100" alt="Github link" title="Github">
