    ...
    <main className="min-h-screen bg-[#050508]">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <motion.div
            className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-[#2563eb]/8 rounded-full blur-[140px]"
            animate={{ scale: [1, 1.08, 1], opacity: [0.5, 0.7, 0.5] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute bottom-1/4 right-1/4 w-[350px] h-[350px] bg-violet-600/6 rounded-full blur-[120px]"
            ...
            <StaggerItem className="lg:col-span-2 space-y-5">
              ...
              <Reveal delay={0.1}>
                <div className="rounded-xl bg-[#0d0d16] border border-white/8 p-5 glow-card">
                  ...
                  <p className="text-xs text-[#94a3b8] mb-3">
                    Join our community for support, updates, and quick
                    questions.
                  </p>
                  <a
